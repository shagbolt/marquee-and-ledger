...
export function showSummaryModal(movie){
    ...
    summaryBody.innerHTML =
      '<h3 style="margin-top:0;">'+escapeHtml(movie.title)+'</h3>'+
      ...
      investorLine+
      '<div class="verdict-badge badge-'+movie.verdictCls+'">'+movie.verdict+'</div>'+
...
export function showAwardsModal(a){
    ...
    awardsBody.innerHTML =
      '<div class="award-row"><div class="award-label">🏆 Best Picture</div><div class="award-winner">'+escapeHtml(a.bestPictureMovie.title)+'</div><div class="award-sub">'+escapeHtml(a.bestPictureMovie.studioName)+' • Quality '+a.bestPictureMovie.quality+'</div></div>'+
      '<div class="award-row"><div class="award-label">🎬 Best Director</div><div class="award-winner">'+escapeHtml(a.bestDirector.label)+'</div><div class="award-sub">for "'+escapeHtml(a.bestDirector.movie.title)+'" ('+escapeHtml(a.bestDirector.movie.studioName)+')</div></div>'+
      '<div class="award-row"><div class="award-label">⭐ Best Actor</div><div class="award-winner">'+escapeHtml(a.bestActor.label)+'</div><div class="award-sub">for "'+escapeHtml(a.bestActor.movie.title)+'" ('+escapeHtml(a.bestActor.movie.studioName)+')</div></div>';
