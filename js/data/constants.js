...
export var writers = [
    {id:'w1', name:'Jordan Blake', skill:55, prestige:50},
    {id:'w2', name:'Morgan Vale', skill:70, prestige:55},
    {id:'w3', name:'Priya Anand', skill:85, prestige:65},
    {id:'w4', name:'Sam Whitfield', skill:45, prestige:40},
    {id:'w5', name:'Elena Cross', skill:90, prestige:70},
    {id:'w6', name:'Devon Osei', skill:60, prestige:50},
    {id:'w7', name:'Casey Lindgren', skill:30, prestige:25},
    {id:'w8', name:'Noah Brightwater', skill:22, prestige:18},
    {id:'w9', name:'Imani Osei', skill:38, prestige:30},
    {id:'w10', name:'Pip Sorensen', skill:1, prestige:0},
    {id:'w11', name:'Zoe Park', skill:3, prestige:2},
    {id:'w12', name:'Eli Fontaine', skill:5, prestige:2}
  ];

export var directors = [
    {id:'d1', name:'Frank Castellan', skill:65, prestige:55},
    {id:'d2', name:'Ridley Hoffman', skill:88, prestige:75},
    {id:'d3', name:'Ava Kwan', skill:72, prestige:60},
    {id:'d4', name:'Marcus Feld', skill:50, prestige:45},
    {id:'d5', name:'Nina Ostrowski', skill:80, prestige:65},
    {id:'d6', name:'Terry Boone', skill:58, prestige:48},
    {id:'d7', name:'Ruth Ambrose', skill:35, prestige:28},
    {id:'d8', name:'Theo Marsh', skill:24, prestige:20},
    {id:'d9', name:'Greta Solano', skill:40, prestige:32},
    {id:'d10', name:'Nadia Colt', skill:1, prestige:0},
    {id:'d11', name:'Bianca Ortiz', skill:2, prestige:2},
    {id:'d12', name:'Sully Vance', skill:3, prestige:3}
  ];

export var stars = [
    {id:'s1', name:'Blake Sterling', starPower:90, prestige:80},
    {id:'s2', name:'Isla Monroe', starPower:85, prestige:78},
    {id:'s3', name:'Derek Nova', starPower:60, prestige:55},
    {id:'s4', name:'Zara Quinn', starPower:75, prestige:68},
    {id:'s5', name:'Owen Marsh', starPower:50, prestige:45},
    {id:'s6', name:'Talia Frost', starPower:95, prestige:88},
    {id:'s7', name:'Cole Bishop', starPower:45, prestige:40},
    {id:'s8', name:'Rosa Delgado', starPower:68, prestige:58},
    {id:'s9', name:'Wren Castillo', starPower:30, prestige:22},
    {id:'s10', name:'Milo Finch', starPower:20, prestige:15},
    {id:'s11', name:'Priya Deshmukh', starPower:38, prestige:28},
    {id:'s12', name:'Reggie Voss', starPower:0, prestige:2},
    {id:'s13', name:'Mabel Trent', starPower:1, prestige:1},
    {id:'s14', name:'Otis Dray', starPower:2, prestige:1}
  ];
...
export function composerFee(c){
    ...
    return round10k(c.skill*20000 + c.prestige*9000);
  }
...
export function producerFee(t){
    ...
    return round10k(t.skill*22000 + t.prestige*11000);
  }
...
export function writerFee(t){ return round10k(t.skill*25000 + t.prestige*10000); }

export function directorFee(t){ return round10k(t.skill*30000 + t.prestige*12000); }

export function starFee(t){ return round10k(t.starPower*45000 + t.prestige*16000); }
