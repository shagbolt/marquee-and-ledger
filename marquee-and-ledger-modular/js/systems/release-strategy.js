...
export var TEST_SCREENING_CHOICES = [
    { id:'asis', label:'Release As-Is', costBase:0, delayWeeks:0, desc:'No changes. Ship it.', targets:[] },
    { id:'reshootEnding', label:'Reshoot the Ending', costBase:300000, delayWeeks:2, desc:'Targets Ending Satisfaction & Awards Potential.', targets:['endingSatisfaction'] },
    { id:'trimRuntime', label:'Trim Runtime', costBase:150000, delayWeeks:1, desc:'Targets Pacing.', targets:['pacing'] },
    { id:'addScenes', label:'Add Scenes', costBase:250000, delayWeeks:2, desc:'Targets Character Likability & Emotional Impact.', targets:['characterLikability','emotionalImpact'] },
    { id:'removeScenes', label:'Remove Scenes', costBase:150000, delayWeeks:1, desc:'Targets Confusion & Pacing.', targets:['confusion','pacing'] },
    { id:'improveVFX', label:'Improve Visual Effects', costBase:400000, delayWeeks:2, desc:'Targets Action & Commercial Appeal.', targets:['action'] },
    { id:'delay', label:'Delay Release', costBase:0, delayWeeks:4, desc:'Buys polish time. Modest, unpredictable quality shift.', targets:[] }
  ];
