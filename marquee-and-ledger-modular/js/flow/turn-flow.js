...
function showOutcomeSummary(cashBefore, prestigeBefore, newsCountBefore){
  ...
  if(game.lastTickPassiveIncome>0){
    lines.push('<div class="outcome-line"><span>📼 Passive Income</span><span style="color:var(--emerald);">+'+formatMoney(game.lastTickPassiveIncome)+'</span></div>');
  }
